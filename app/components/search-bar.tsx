...
import { colorMap, sortOptions } from "~/utils/constants"
...
export function SearchBar({ profile }: props) {
    ...
    return (
        ...
        <form className="w-full px-6 flex items-center gap-x-4 border-b-4 border-b-blue-900 border-opacity-30 h-20">
            ...
            <p className={`text-gray-300 font-bold text-lg whitespace-pre-wrap break-all`} >{profile.firstName} {profile.lastName}</p>
